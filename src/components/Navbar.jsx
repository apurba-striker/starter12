...
export const Navbar = () => {
  ...
  return (
    <nav className="w-full h-20 flex flex-col justify-center  items-center relative bg-[#D0E7EB] lg:bg-[#D0E7EB] z-40 lg:backdrop-blur-xl">
      <div className="2xl:w-[1280px] xl:w-10/12 w-11/12 flex justify-between items-center relative">
        ...
        >
          <a className="navbar-link" href="#home" aria-label="Home">
            <div className="flex justify-start items-center grow basis-0">
                ...
                <img src={vector}/><div className="flex"><img src={Group}/> </div>
        ...
        >
          ...
          <div className="text-[#1A535C] grow flex justify-center items-center p-0 font-abc ">
            ...
            <a
              className="text-[#FFFFFF] custom-border-green 
           bg-[#15B776] hover:bg-[#15B776]  border-gray-700 pl-6 pr-8 pt-2 pb-2 text-sm flex"
              href="#"
              target="_blank"
      ...
      <AnimatePresence>
        ...
        "
           ...
           bg-green-500 hover:bg-customDarkBg3  border-gray-700 pl-6 pr-8 pt-2 pb-2 text-sm flex"
              href="#"
              target="_blank"
              aria-label="source code"
            >
